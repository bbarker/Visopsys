...
// Functions exported from kernelNetworkUdp.c
int kernelNetworkUdpSetupReceivedPacket(kernelNetworkPacket *);
void kernelNetworkUdpPrependHeader(kernelNetworkPacket *);
