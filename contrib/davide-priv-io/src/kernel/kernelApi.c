...
static kernelFunctionIndex multitaskerFunctionIndex[] = {
  ...
  { _fnum_multitaskerAllowIO, kernelMultitaskerAllowIO, 2, PRIVILEGE_SUPERVISOR}, 
  { _fnum_multitaskerNotAllowIO, kernelMultitaskerNotAllowIO, 2, PRIVILEGE_SUPERVISOR}
};
