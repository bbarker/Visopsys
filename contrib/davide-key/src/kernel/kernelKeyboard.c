...
// added by Davide Airaghi for the italian keyboard layout
static kernelKeyMap IT_IT = {
  "Italian(IT)",
  // Regular map
  { 27,'1','2','3','4','5','6','7','8','9','0','\'',0xec,8,9,'q',    // 00-0F
    'w','e','r','t','y','u','i','o','p',0xe8,'+',10,0,'a','s','d',  // 10-1F
    'f','g','h','j','k','l',0xf2,0xe0,'\\',0,0xf9,'z','x','c','v','b', // 20-2F
    'n','m',',','.', '-',0,'*',0,' ',0,0,0,0,0,0,0,                 // 30-3F
    0,0,0,0,0,0,13,17,11,'-',18,'5',19,'+',0,20,                   // 40-4F
    12,0,0x7f,0,0,'<'                                                 // 50-55
  },
  // Shift map
  { 27,'!','"',0xa3,'$','%','&','/','(',')','=','?','^',8,9,'Q',    // 00-0F
    'W','E','R','T','Y','U','I','O','P',0xe9,'*',10,0,'A','S','D',  // 10-1F 
    'F','G','H','J','K','L',0xe7,0xb0,'|',0,0xa7,'Z','X','C','V','B', // 20-2F
  ...
  { 27,'1','2','3','4','5','6','{','[',']','}','`','~',8,9,'q',    // 00-0F
    'w','e','r','t','y','u','i','o','p','[',']',10,0,'a','s','d',  // 10-1F
    'f','g','h','j','k','l','@','#','\\',0,0xf9,'z','x','c','v','b', // 20-2F
    'n','m',',','.', '-',0,'*',0,' ',0,0,0,0,0,0,0,                 // 30-3F
    0,0,0,0,0,0,13,17,11,'-',18,'5',19,'+',0,20,                   // 40-4F
    12,0,127,0,0,'<'                                                 // 50-55
  },
